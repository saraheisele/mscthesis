...
def plot_prototypes_stacked_panel(
    ...
    *,
    ...
    if not all(p.exists() for p in paths):
        console.log("[yellow]Missing individual prototype PNGs — skip stacked panel.")
        return None
    ...
    total_w = max(im.width for im in resized)
